...
if ops.Nchan >32
    ops.NT               = 128*32+ ops.ntbuff;% this is the batch size (try decreasing if out of memory) for GPU should be multiple of 32  + ntbuff
else
    ops.NT               = 1024*32+ ops.ntbuff;% this is the batch size (try decreasing if out of memory) for GPU should be multiple of 32  + ntbuff
end
